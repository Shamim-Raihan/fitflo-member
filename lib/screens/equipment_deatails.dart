...
class EquipmentDeatils extends StatefulWidget {
  final String title,category,objective;
  const EquipmentDeatils({super.key,required this.title, required this.category,required this.objective});

  @override
  State<EquipmentDeatils> createState() => _EquipmentDeatilsState();
}

class _EquipmentDeatilsState extends State<EquipmentDeatils> {
